...
@capacidad_carga_rutas.post("/crear_capacidad_carga/{medicion_aforo}/{hectareas_predio}/{periodo_ocupacion}/{nombre_potreros}", status_code=status.HTTP_201_CREATED)
