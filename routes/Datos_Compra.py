...
async def crear_reporte_compras(id_bovino:str,estado:str,numero_bono_compra:str,fecha_compra:date,precio_compra:int,razon_compra:str,medio_pago_compra:str,comprador:str ):
...
async def inventario_bovinos_compra_id(id_bovino:str):
    try:
...
async def listar_tabla_compras():
    try:
