...
"""la siguinete funcion revisa los animales preñados y notifica cuando una vaca esta proxima a parir"""

def notificacion_palpacion_parto(session:Session,current_user):
    try:
        #consulta que trae el listado de animales en leche
        animales_palpaciones= session.query(modelo_bovinos_inventario.c.estado, modelo_leche.c.id_bovino,
